...
for idx, r in tqdm(df_param_run.iterrows()):
    ...
    if not os.path.isdir( os.path.join(results_path, str(num_nodes), args.type_sim, args.network_type) ):
        os.makedirs(os.path.join(results_path, str(num_nodes), args.type_sim, args.network_type))
        
    if not os.path.isdir( os.path.join(results_path, str(num_nodes), args.type_sim, args.network_type, 'checkpoints') ):
